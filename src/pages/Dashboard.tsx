  ...
  return (
    <div className="font-sans bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/40 overflow-x-hidden min-h-screen">
      ...
      <div id="root-container" className="pt-10 min-h-screen flex flex-col pb-20">
        ...
        {/* Spending Overview / Visual Insights */}
        ...
        <div id="alerts-reminders" className="px-4 pb-5">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 shadow-md border border-blue-100/50">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-sm">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between">
                    <div>
                      <h4 className="text-sm font-semibold text-gray-900">Unusual Spending</h4>
                      <p className="text-xs text-gray-500">Dining expenses 35% higher than usual</p>
                    </div>
                    <button className="text-xs text-blue-600 font-semibold">Details</button>
                  </div>
                </div>
              </div>
            </div>
